...
authors: "Nicole Bovenga, Vincent de Jong, Isa Bos"
date: "`r Sys.Date()`"
output:
  html_document:
    css: style.css
...
Wij hebben voor dit onderzoek de lengte en breedete van de handen van verschillende mensen gemeeten, en daarna gekeken of er verschil is tussen mannen en vrouwen. Met de gegevens hebben we grafiekjes gemaakt om het verschil duidelijk te zien.
...
Maatlat of Meetlint 
Een spreadsheet om de resultaten vast te leggen
